    ...
    <div className="modal-backdrop animate-fade-in">
      <div className="bg-[#FBF9F5] rounded-2xl max-w-2xl w-full max-h-[85vh] overflow-y-auto shadow-2xl border border-[#E5E0DA] relative my-8 p-6 md:p-10">
        ...
        <div className="text-center space-y-3 mb-8 pb-6 border-b border-[#E5E0DA]">
          <span className="inline-flex items-center gap-1.5 text-xs font-bold text-[#8C2520] uppercase tracking-widest bg-red-100/60 px-3 py-1 rounded-full">
        ...
        <div className="prose prose-slate max-w-none font-serif text-base sm:text-lg leading-relaxed text-slate-800 space-y-6">
          <p className="first-letter:float-left first-letter:text-5xl first-letter:font-bold first-letter:text-[#8C2520] first-letter:mr-3 first-letter:leading-none">
          ...
          <blockquote className="border-l-4 border-[#8C2520] pl-4 italic text-slate-700 bg-amber-50/50 py-3 pr-2 my-6 rounded-r-lg">
        ...
        <div className="mt-10 pt-6 border-t border-[#E5E0DA] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button 
            onClick={onClose}
            className="w-full sm:w-auto bg-[#8C2520] hover:bg-[#A62D27] text-white px-6 py-2.5 rounded-xl font-sans text-xs font-bold transition-colors"
          >
